				...
				<div className="w-[1220px] mx-auto max-w-full py-[150px] max-md:py-[60px]">
					<div className="flex flex-col justify-center items-center w-[60%] mx-auto max-md:w-full gap-4">
						...
						<p className="text-base text-center text-gray-800 max-md:text-sm">
							En Brumalab le generamos valor a su marca desde una metodología
							que integra lo mejor de la creatividad y la funcionalidad.
						</p>
						<div className="mt-6">
							<Button
								style={
						...
						<Accordion className="space-y-5">
							<AccordionItem className="border-b-[1px] py-4">
								...
								<AccordionPanel
									...
									mt={10}
								>
									Su página web es el medio para conectar su marca con el mundo.
									Por eso la diseñamos y la administramos para que sea el
									reflejo de sus valores corporativos y sea competente según el
									mercado al que pertenece.¡Contáctanos hoy mismo y déjanos
									diseñar la tienda online de tus sueños!
								</AccordionPanel>
							</AccordionItem>
							<AccordionItem className="border-b-[1px] py-4">
								<h2>
								...
								<AccordionPanel
									...
									mt={10}
								>
									Si estás buscando dar vida a tu tienda online con un diseño
									profesional y personalizado, estás en el lugar adecuado.
									Permítenos ser tus aliados en este emocionante viaje hacia el
									éxito en el mundo digital. ¡Contáctanos hoy mismo y déjanos
									diseñar la tienda online de tus sueños!
								</AccordionPanel>
							</AccordionItem>
							<AccordionItem className="border-b-[1px] py-4">
				...
				>
					<SwiperSlide className="bg-white p-10 rounded-md shadow-lg shadow-black/40 my-10 mx-4 space-y-5 max-md:mx-0">
						...
						<p className="text-xs font-medium text-justify">
							...
							inventore, tempora voluptate voluptas non est, ut temporibus quia
							ratione earum eos deleniti".
						</p>
